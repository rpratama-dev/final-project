                  ...
                  <div class="row ml-1">
                    ...
                    <div class="ml-auto mr-3">
                        <div class="user-block float-right">
                            <img class="img-circle img-bordered-sm" src="{{ asset($best_answer->photo_dir) }}" alt="User Image">
                            <span class="username">
                              <a href="#">{{ $best_answer->name }}Name</a> 
                            </span>
                            <span class="description">reputasi ({{ $best_answer->point_reputasi }})</span>
                        </div> 
                    </div>
                  </div>
